...
- Manual steps for running checks locally:
  ...
  3) Optionally validate the UI change locally in a browser.
...
Single developer quick checklist:
- Trivial change: `git add . && git commit -m "fix: ..." && ./bin/check && git push`
- Non-trivial change: `git checkout -b feat/your-change && ./bin/check && git commit && git push && gh pr create`
