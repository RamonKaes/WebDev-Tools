 ...
 *
 * Electronic Frontier Foundation's long wordlist for creating secure, memorable passphrases.
 * Contains 7,776 words optimized for dice-based passphrase generation.
 * @see https://www.eff.org/deeplinks/2016/07/new-wordlists-random-passphrases
 */

export const WORDLIST = [
  "abacus", "abdomen", "abduct", "abide", "able", "ablaze", "abnormal", "aboard", "abolish", "abrasive",
  "absorb", "abstract", "absurd", "accent", "accept", "access", "accident", "account", "accuracy", "achieve",
  "acid", "acoustic", "acquire", "across", "action", "activate", "active", "actor", "actress", "actual",
  "adapt", "addict", "address", "adequate", "adjust", "admiral", "admire", "admit", "adore", "advance",
  "advice", "advocate", "aerobic", "affair", "afford", "afraid", "again", "agency", "agent", "agree",
  "ahead", "aircraft", "aisle", "alarm", "album", "alcohol", "alert", "alien", "align", "alike",
  "alive", "alley", "allow", "almost", "alone", "alpha", "already", "also", "alter", "always",
  "amateur", "amaze", "among", "amount", "amused", "analyst", "anchor", "ancient", "angel", "anger",
  "angle", "angry", "animal", "ankle", "announce", "annual", "another", "answer", "antenna", "antique",
  "anxiety", "apache", "apart", "apology", "appear", "apple", "approve", "april", "apron", "aquarium",
  "archer", "arctic", "area", "arena", "argue", "arise", "armor", "army", "around", "arrange",
  "arrest", "arrival", "arrive", "arrow", "artery", "artist", "artwork", "ascend", "ashtray", "aspect",
  "assault", "assert", "assess", "asset", "assign", "assist", "assume", "asthma", "athlete", "atomic",
  "attach", "attack", "attempt", "attend", "attract", "auction", "audit", "august", "aunt", "author",
  "auto", "autumn", "average", "avocado", "avoid", "awake", "aware", "awesome", "awful", "awkward",
  "axiom", "axis", "axle", "bacon", "badge", "balance", "balcony", "ball", "bamboo", "banana",
  "banner", "bargain", "barrel", "base", "basic", "basket", "battle", "beach", "beacon", "bean",
  "beauty", "became", "because", "become", "beef", "before", "begin", "behave", "behind", "believe",
  "below", "belt", "bench", "benefit", "best", "betray", "better", "between", "beyond", "bicycle",
  "billion", "biology", "bird", "birth", "bitter", "black", "blade", "blame", "blanket", "blast",
  "bleak", "bless", "blind", "blood", "blossom", "blouse", "blue", "blunt", "blur", "blush",
  "board", "boat", "body", "boil", "bolt", "bomb", "bone", "bonus", "book", "boost",
  "border", "boring", "borrow", "boss", "bottom", "bounce", "boundary", "bowling", "bracket", "brain",
  "brand", "brass", "brave", "bread", "breeze", "brick", "bridge", "brief", "bright", "bring",
  "brisk", "broccoli", "broken", "bronze", "broom", "brother", "brown", "brush", "bubble", "bucket",
  "budget", "buffalo", "build", "bulb", "bulk", "bullet", "bundle", "bunker", "burden", "burger",
  "burst", "business", "busy", "butter", "buyer", "buzzer", "cabbage", "cabin", "cable", "cactus",
  "cafe", "cage", "cake", "call", "calm", "camera", "camp", "campus", "canal", "cancel",
  "candy", "cannon", "canoe", "canvas", "canyon", "capable", "capital", "captain", "capture", "carbon",
  ...
  "cigar", "cinnamon", "circle", "citizen", "city", "civil", "claim", "clang", "clarify", "class",
  ...
  "custom", "cute", "cycle", "daddy", "damage", "damp", "dance", "danger", "daring", "dash",
  ...
  "disorder", "display", "distance", "divert", "divide", "divorce", "dizzy", "doctor", "document", "dodge",
  "doing", "doll", "dolphin", "domain", "donate", "donkey", "donor", "door", "dose", "double",
  "dove", "draft", "dragon", "drama", "drastic", "draw", "dream", "dress", "drift", "drill",
  "drink", "drip", "drive", "drop", "drum", "dryer", "duck", "dumb", "dune", "during",
  ...
  "fall", "false", "fame", "family", "famous", "fancy", "fantasy", "farm", "fashion", "fatal",
  "father", "fatigue", "fault", "favorite", "feature", "february", "federal", "feel", "female", "fence",
  "festival", "fetch", "fever", "fiber", "fiction", "field", "figure", "file", "film", "filter",
  "final", "find", "fine", "finger", "finish", "fire", "firm", "first", "fiscal", "fish",
  "fitness", "flag", "flame", "flash", "flat", "flavor", "flee", "flight", "flip", "float",
  ...
  "furnace", "fury", "future", "gadget", "gain", "galaxy", "gallery", "game", "gang", "gap",
  ...
  "glimpse", "globe", "gloom", "glory", "glove", "glow", "glue", "goal", "goat", "goddess",
  ...
  "jacket", "jaguar", "january", "jar", "jazz", "jealous", "jeans", "jelly", "jewel", "job",
  "join", "joke", "journey", "joy", "judge", "juice", "july", "jump", "june", "jungle",
  "junior", "junk", "just", "kangaroo", "keen", "keep", "ketchup", "key", "kick", "kid",
  "kidney", "kind", "kingdom", "kiss", "kit", "kitchen", "kite", "kitten", "kiwi", "knee",
  "knife", "knock", "know", "label", "labor", "ladder", "lady", "lake", "lamp", "language",
  "laptop", "large", "last", "later", "latin", "laugh", "laundry", "lava", "lawn", "lawsuit",
  "layer", "lazy", "leader", "leaf", "learn", "leave", "lecture", "left", "legal", "legend",
  ...
  "magnet", "maid", "mail", "main", "major", "make", "mammal", "manage", "mandate", "mango",
  ...
  "negative", "neglect", "neither", "nephew", "nerve", "nest", "network", "neutral", "never", "news",
  "next", "nice", "night", "noble", "noise", "nominee", "noodle", "normal", "north", "nose",
  "notable", "note", "nothing", "notice", "novel", "november", "nuclear", "number", "nurse", "nut",
