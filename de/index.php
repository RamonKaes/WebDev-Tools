    ...
    <div class="tool-container-inner mx-auto">
      ...
      <div class="row g-4" id="toolsGrid">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="converters">
          <a href="<?= $dashboardToolBaseUrl ?>daten-konverter/" data-tool-id="dataConverterTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="converters">
          <a href="<?= $dashboardToolBaseUrl ?>px-zu-rem-konverter/" data-tool-id="pxToRemConverter" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="generators">
          <a href="<?= $dashboardToolBaseUrl ?>passwort-generator/" data-tool-id="passwordGeneratorTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-shield-lock me-2"></i>
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="references">
          <a href="<?= $dashboardToolBaseUrl ?>zeichen-referenz/" data-tool-id="characterReferenceTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-table me-2"></i>
                  <?= htmlspecialchars($tools['characterReferenceTool']['title'] ?? 'HTML Zeichenreferenz', ENT_QUOTES, 'UTF-8') ?>
                </h3>
                <p class="card-text text-secondary flex-grow-1">
        ...
        <!-- Emoji-Referenz -->
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="references">
          <a href="<?= $dashboardToolBaseUrl ?>emoji-referenz/" data-tool-id="emojiReferenceTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-emoji-smile me-2"></i>
                  <?= htmlspecialchars($tools['emojiReferenceTool']['title'] ?? 'Emoji-Referenz', ENT_QUOTES, 'UTF-8') ?>
                </h3>
                <p class="card-text text-secondary flex-grow-1">
