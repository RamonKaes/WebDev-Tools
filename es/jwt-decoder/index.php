...
$customNoticeContent = <<<HTML
    <h2 class="h6 fw-semibold alert-heading mb-3"><i class="bi bi-shield-exclamation me-2"></i>Información de seguridad importante</h2>
    <ul class="mb-2">
...
$usefulResources = [
    [
        'url' => 'https://es.wikipedia.org/wiki/JSON_Web_Token',
        'title' => 'Wikipedia: JSON Web Token',
        'description' => 'Introducción accesible a los conceptos y estructura de JWT'
    ],
    [
        'url' => 'https://jwt.io/',
        'title' => 'JWT.io',
