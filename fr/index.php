...
<head>
  ...
  <meta name="keywords" content="Formateur JSON, Encodeur Base64, Encodeur URL, Générateur UUID, Générateur de Mot de Passe, Générateur Hash, Outils pour Développeurs Web">
  ...
  <main class="flex-grow-1 p-4 p-md-5 bg-body shadow-sm overflow-auto">
    <div class="tool-container-inner mx-auto">
      <div class="text-center mb-5">
        <h1 class="display-5 mb-3">Outils gratuits pour les développeurs</h1>
        <p class="lead text-secondary">Utilitaires pour les développeurs web.</p>
      </div>
      ...
      <ul class="nav nav-tabs mb-4 d-none d-lg-flex" id="categoryTabs" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="all-tab" data-category="all" type="button"
            role="tab" aria-selected="true">Tous les Outils</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="encoders-tab" data-category="encoders" type="button"
            role="tab" aria-selected="false"
            title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['encoders'] ?? 'Afficher les outils d\'encodage et de décodage', ENT_QUOTES, 'UTF-8') ?>">Encodeurs</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="formatters-tab" data-category="formatters" type="button"
            role="tab" aria-selected="false"
            title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['formatters'] ?? 'Afficher les outils de formatage et de validation', ENT_QUOTES, 'UTF-8') ?>">Formateurs</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="converters-tab" data-category="converters" type="button"
            role="tab" aria-selected="false"
            title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['converters'] ?? 'Afficher les utilitaires de conversion', ENT_QUOTES, 'UTF-8') ?>">Convertisseurs</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="generators-tab" data-category="generators" type="button"
            role="tab" aria-selected="false"
            title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['generators'] ?? 'Afficher les outils de génération', ENT_QUOTES, 'UTF-8') ?>">Générateurs</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="stringtools-tab" data-category="stringtools" type="button"
            role="tab" aria-selected="false"
            title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['stringtools'] ?? 'Afficher les outils de manipulation de chaînes', ENT_QUOTES, 'UTF-8') ?>">Outils de Texte</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="references-tab" data-category="references" type="button"
            role="tab" aria-selected="false"
            title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['references'] ?? 'Afficher les outils de référence et de consultation', ENT_QUOTES, 'UTF-8') ?>">Références</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="utilities-tab" data-category="utilities" type="button"
            role="tab" aria-selected="false"
            title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['utilities'] ?? 'Afficher les utilitaires', ENT_QUOTES, 'UTF-8') ?>">Utilitaires</button>
        </li>
      </ul>
      ...
      <div class="dropdown mb-4 d-lg-none">
        <button class="btn btn-outline-secondary dropdown-toggle w-100" type="button" id="categoryDropdown" data-bs-toggle="dropdown" aria-expanded="false">
          <i class="bi bi-funnel me-2"></i><span id="selectedCategory">Tous les Outils</span>
        </button>
        <ul class="dropdown-menu w-100" aria-labelledby="categoryDropdown">
          <li><a class="dropdown-item active" href="#" data-category="all">Tous les Outils</a></li>
          <li><a class="dropdown-item" href="#" data-category="encoders" 
              title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['encoders'] ?? 'Afficher les outils d\'encodage et de décodage', ENT_QUOTES, 'UTF-8') ?>">Encodeurs</a></li>
          <li><a class="dropdown-item" href="#" data-category="formatters" 
              title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['formatters'] ?? 'Afficher les outils de formatage et de validation', ENT_QUOTES, 'UTF-8') ?>">Formateurs</a></li>
          <li><a class="dropdown-item" href="#" data-category="converters" 
              title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['converters'] ?? 'Afficher les utilitaires de conversion', ENT_QUOTES, 'UTF-8') ?>">Convertisseurs</a></li>
          <li><a class="dropdown-item" href="#" data-category="generators" 
              title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['generators'] ?? 'Afficher les outils de génération', ENT_QUOTES, 'UTF-8') ?>">Générateurs</a></li>
          <li><a class="dropdown-item" href="#" data-category="stringtools" 
              title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['stringtools'] ?? 'Afficher les outils de manipulation de chaînes', ENT_QUOTES, 'UTF-8') ?>">Outils de Texte</a></li>
          <li><a class="dropdown-item" href="#" data-category="references" 
              title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['references'] ?? 'Afficher les outils de référence et de consultation', ENT_QUOTES, 'UTF-8') ?>">Références</a></li>
          <li><a class="dropdown-item" href="#" data-category="utilities" 
              title="<?= htmlspecialchars($t['navigation']['categories']['filterTitle']['utilities'] ?? 'Afficher les utilitaires', ENT_QUOTES, 'UTF-8') ?>">Utilitaires</a></li>
        </ul>
      </div>
      
      <div class="row g-4" id="toolsGrid">
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="encoders">
          <a href="<?= getToolUrl('base64EncoderDecoder', 'fr') ?>" data-tool-id="base64EncoderDecoder" class="text-decoration-none" title="<?= htmlspecialchars($tools['base64EncoderDecoder']['linkTitle']['card'] ?? $tools['base64EncoderDecoder']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="encoders">
          <a href="<?= getToolUrl('urlEncoderDecoder', 'fr') ?>" data-tool-id="urlEncoderDecoder" class="text-decoration-none" title="<?= htmlspecialchars($tools['urlEncoderDecoder']['linkTitle']['card'] ?? $tools['urlEncoderDecoder']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="encoders">
          <a href="<?= getToolUrl('htmlEntityTool', 'fr') ?>" data-tool-id="htmlEntityTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['htmlEntityTool']['linkTitle']['card'] ?? $tools['htmlEntityTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="encoders">
          <a href="<?= getToolUrl('jwtDecoderTool', 'fr') ?>" data-tool-id="jwtDecoderTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['jwtDecoderTool']['linkTitle']['card'] ?? $tools['jwtDecoderTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="encoders">
          <a href="<?= getToolUrl('punycodeConverterTool', 'fr') ?>" data-tool-id="punycodeConverterTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['punycodeConverterTool']['linkTitle']['card'] ?? $tools['punycodeConverterTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="formatters">
          <a href="<?= getToolUrl('jsonFormatterValidator', 'fr') ?>" data-tool-id="jsonFormatterValidator" class="text-decoration-none" title="<?= htmlspecialchars($tools['jsonFormatterValidator']['linkTitle']['card'] ?? $tools['jsonFormatterValidator']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="formatters">
          <a href="<?= getToolUrl('codeFormatterTool', 'fr') ?>" data-tool-id="codeFormatterTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['codeFormatterTool']['linkTitle']['card'] ?? $tools['codeFormatterTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
                    <i class="bi bi-code-square me-2"></i>
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="converters">
          <a href="<?= getToolUrl('dataConverterTool', 'fr') ?>" data-tool-id="dataConverterTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['dataConverterTool']['linkTitle']['card'] ?? $tools['dataConverterTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="converters">
          <a href="<?= getToolUrl('pxToRemConverter', 'fr') ?>" data-tool-id="pxToRemConverter" class="text-decoration-none" title="<?= htmlspecialchars($tools['pxToRemConverter']['linkTitle']['card'] ?? $tools['pxToRemConverter']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="converters">
          <a href="<?= getToolUrl('aspectRatioCalculator', 'fr') ?>" data-tool-id="aspectRatioCalculator" class="text-decoration-none" title="<?= htmlspecialchars($tools['aspectRatioCalculator']['linkTitle']['card'] ?? $tools['aspectRatioCalculator']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
                    <i class="bi bi-aspect-ratio me-2"></i>
                    <?= htmlspecialchars($tools['aspectRatioCalculator']['toc_title'] ?? 'Ratio d\'Aspect', ENT_QUOTES, 'UTF-8') ?>
                  </div>
                  <p class="card-text text-secondary flex-grow-1">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="generators">
          <a href="<?= getToolUrl('uuidGeneratorTool', 'fr') ?>" data-tool-id="uuidGeneratorTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['uuidGeneratorTool']['linkTitle']['card'] ?? $tools['uuidGeneratorTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="generators">
          <a href="<?= getToolUrl('passwordGeneratorTool', 'fr') ?>" data-tool-id="passwordGeneratorTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['passwordGeneratorTool']['linkTitle']['card'] ?? $tools['passwordGeneratorTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
                    <i class="bi bi-shield-lock me-2"></i>
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="generators">
          <a href="<?= getToolUrl('hashGeneratorTool', 'fr') ?>" data-tool-id="hashGeneratorTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['hashGeneratorTool']['linkTitle']['card'] ?? $tools['hashGeneratorTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="generators">
          <a href="<?= getToolUrl('loremIpsumTool', 'fr') ?>" data-tool-id="loremIpsumTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['loremIpsumTool']['linkTitle']['card'] ?? $tools['loremIpsumTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="generators">
          <a href="<?= getToolUrl('qrCodeGeneratorTool', 'fr') ?>" data-tool-id="qrCodeGeneratorTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['qrCodeGeneratorTool']['linkTitle']['card'] ?? $tools['qrCodeGeneratorTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="stringtools">
          <a href="<?= getToolUrl('stringEscaperTool', 'fr') ?>" data-tool-id="stringEscaperTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['stringEscaperTool']['linkTitle']['card'] ?? $tools['stringEscaperTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <!-- Référence de Caractères HTML -->
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="references">
          <a href="<?= getToolUrl('characterReferenceTool', 'fr') ?>" data-tool-id="characterReferenceTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['characterReferenceTool']['linkTitle']['card'] ?? $tools['characterReferenceTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
                    <i class="bi bi-table me-2"></i>
                    <?= htmlspecialchars($tools['characterReferenceTool']['toc_title'] ?? 'Référence de Caractères HTML', ENT_QUOTES, 'UTF-8') ?>
                  </div>
                  <p class="card-text text-secondary flex-grow-1">
                    <?= htmlspecialchars($tools['characterReferenceTool']['card_description'] ?? 'Explorer les entités HTML, caractères Unicode et symboles spéciaux', ENT_QUOTES, 'UTF-8') ?>
                  </p>
              </div>
            </div>
          </a>
        ...
        <!-- Référence d'Emojis -->
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="references">
          <a href="<?= getToolUrl('emojiReferenceTool', 'fr') ?>" data-tool-id="emojiReferenceTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['emojiReferenceTool']['linkTitle']['card'] ?? $tools['emojiReferenceTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
                    <i class="bi bi-emoji-smile me-2"></i>
                    <?= htmlspecialchars($tools['emojiReferenceTool']['toc_title'] ?? 'Référence d\'Emojis', ENT_QUOTES, 'UTF-8') ?>
                  </div>
                  <p class="card-text text-secondary flex-grow-1">
                    <?= htmlspecialchars($tools['emojiReferenceTool']['card_description'] ?? 'Explorer et copier des emojis avec codes Unicode', ENT_QUOTES, 'UTF-8') ?>
                  </p>
              </div>
            </div>
          </a>
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="utilities">
          <a href="<?= getToolUrl('regexTesterTool', 'fr') ?>" data-tool-id="regexTesterTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['regexTesterTool']['linkTitle']['card'] ?? $tools['regexTesterTool']['toc_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                  <div class="card-title fs-6 fw-semibold mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="utilities">
          <a href="<?= getToolUrl('sriGeneratorTool', 'fr') ?>" data-tool-id="sriGeneratorTool" class="text-decoration-none" title="<?= htmlspecialchars($tools['sriGeneratorTool']['linkTitle']['card'] ?? 'SRI Generator', ENT_QUOTES, 'UTF-8') ?>">
              <div class="card h-100 tool-card">
                <div class="card-body d-flex flex-column">
                <div class="card-title fs-6 fw-semibold mb-2">
                    <i class="bi bi-shield-check me-2"></i>
                    <?= htmlspecialchars($tools['sriGeneratorTool']['toc_title'] ?? 'SRI Generator', ENT_QUOTES, 'UTF-8') ?>
                  </div>
                  <p class="card-text text-secondary flex-grow-1">
                    <?= htmlspecialchars($tools['sriGeneratorTool']['card_description'] ?? '', ENT_QUOTES, 'UTF-8') ?>
                  </p>
              </div>
            </div>
          </a>
