  ...
  <main class="flex-grow-1 p-4 p-md-5 bg-body shadow-sm overflow-auto">
    <div class="tool-container-inner mx-auto">
      ...
      <div class="row g-4" id="toolsGrid">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="encoders">
          <a href="<?= $dashboardToolBaseUrl ?>url-encoder-decoder/" data-tool-id="urlEncoderDecoder" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="converters">
          <a href="<?= $dashboardToolBaseUrl ?>convertisseur-donnees/" data-tool-id="dataConverterTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-arrow-left-right me-2"></i>
                  <?= htmlspecialchars($tools['dataConverterTool']['title'] ?? 'Daten-Konverter', ENT_QUOTES, 'UTF-8') ?>
                </h3>
                <p class="card-text text-secondary flex-grow-1">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="converters">
          <a href="<?= $dashboardToolBaseUrl ?>convertisseur-px-vers-rem/" data-tool-id="pxToRemConverter" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-arrows-angle-expand me-2"></i>
                  <?= htmlspecialchars($tools['pxToRemConverter']['title'] ?? 'PX ⇄ REM Konverter', ENT_QUOTES, 'UTF-8') ?>
                </h3>
                <p class="card-text text-secondary flex-grow-1">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="generators">
          <a href="<?= $dashboardToolBaseUrl ?>generateur-mots-de-passe/" data-tool-id="passwordGeneratorTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-shield-lock me-2"></i>
                  <?= htmlspecialchars($tools['passwordGeneratorTool']['title'] ?? 'Passwort Generator', ENT_QUOTES, 'UTF-8') ?>
                </h3>
                <p class="card-text text-secondary flex-grow-1">
        ...
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="references">
          <a href="<?= $dashboardToolBaseUrl ?>reference-caracteres/" data-tool-id="characterReferenceTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-table me-2"></i>
                  <?= htmlspecialchars($tools['characterReference']['title'] ?? 'Référence de Caractères HTML', ENT_QUOTES, 'UTF-8') ?>
                </h3>
                <p class="card-text text-secondary flex-grow-1">
                  <?= htmlspecialchars($tools['characterReference']['description'] ?? 'Explorer les entités HTML, caractères Unicode et symboles spéciaux', ENT_QUOTES, 'UTF-8') ?>
                </p>
              </div>
            </div>
          </a>
        ...
        <!-- Référence d'Emojis -->
        <div class="col-12 col-md-6 col-lg-4 tool-item" data-category="references">
          <a href="<?= $dashboardToolBaseUrl ?>reference-emoji/" data-tool-id="emojiReferenceTool" class="text-decoration-none">
            <div class="card h-100 tool-card">
              <div class="card-body d-flex flex-column">
                  <h3 class="card-title fs-custom-18 mb-2">
                  <i class="bi bi-emoji-smile me-2"></i>
                  <?= htmlspecialchars($tools['emojiReference']['title'] ?? 'Référence d\'Emojis', ENT_QUOTES, 'UTF-8') ?>
                </h3>
                <p class="card-text text-secondary flex-grow-1">
                  <?= htmlspecialchars($tools['emojiReference']['description'] ?? 'Explorer et copier des emojis avec codes Unicode', ENT_QUOTES, 'UTF-8') ?>
                </p>
              </div>
            </div>
          </a>
