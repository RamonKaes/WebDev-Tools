...
$customNoticeContent = <<<HTML
    <h2 class="h6 fw-semibold alert-heading mb-3"><i class="bi bi-shield-exclamation me-2"></i>Informazioni di sicurezza importanti</h2>
    <ul class="mb-2">
...
$usefulResources = [
    [
        'url' => 'https://it.wikipedia.org/wiki/JSON_Web_Token',
        'title' => 'Wikipedia: JSON Web Token',
        'description' => 'Introduzione accessibile ai concetti e alla struttura dei JWT'
    ],
    [
        'url' => 'https://jwt.io/',
        'title' => 'JWT.io',
