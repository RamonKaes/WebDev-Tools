...
$customNoticeContent = <<<HTML
    <h2 class="h6 fw-semibold alert-heading mb-3"><i class="bi bi-shield-exclamation me-2"></i>Informações importantes</h2>
    <ul class="mb-2">
...
$usefulResources = [
    [
        ...
        'description' => 'Introdução acessível aos conceitos e estrutura do JWT'
    ],
    [
        'url' => 'https://jwt.io/',
        'title' => 'JWT.io',
